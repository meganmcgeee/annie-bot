...
_bot2.default.dialog('/newYork/bk/healthcare', [function (session) {
  ...
  })).then((0, _map2.default)(message)).then(sendMessages(session));
}]);
...
function detailsMessage(_ref2) {
  var _ref2$fields = _ref2.fields,
      phone = _ref2$fields.Phone,
      services = _ref2$fields.Services,
      hours = _ref2$fields.Hours;
...
function sendMessages(session) {
  return function (msgs) {
    return msgs.forEach((0, _forEach2.default)(function (msg) {
      return session.send(msg);
    }));
  };
}
